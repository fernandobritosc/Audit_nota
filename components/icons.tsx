...
// --- Componente ApiKeyModal movido para cá para resolver problema de importação ---
            ...
            {!result && !isLoading && (
              <div className="space-y-6 no-print">
                ...
                <p className="text-center text-xs text-slate-500 dark:text-slate-400 -mt-4">
                  Use os botões acima para alternar entre a análise de documentos e a entrada manual de dados.
                </p>
                {mode === 'analysis' ? (
                    <>
