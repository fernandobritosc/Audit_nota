...
const App: React.FC = () => {
  ...
  const handleTaxStatusChange = useCallback((key: 'optanteSimples' | 'isMei') => {
    ...
    const dataForRecalc: ExtractedData = {
      ...
      // Omit valorINSS to force recalculation from base/rate
  ...
  const handleValueChange = useCallback((key: ManualChangeKey, value: string | number) => {
    setResult(prevResult => {
        ...
        // Update the source-of-truth values directly on our result copy
        ...
        // Create the data object for recalculation based on the updated values
        const dataForRecalc: ExtractedData = {
            ...updatedResult,
        ...
        // Merge the recalculated data back into our result object
      ...
      <div className="w-full max-w-2xl mx-auto print:max-w-none print:w-full print:p-8">
        <header className="text-center mb-6 no-print relative">
          ...
          <div className="flex justify-center items-center gap-3 mb-1">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-700 to-slate-800 dark:from-blue-400 dark:to-slate-200">
