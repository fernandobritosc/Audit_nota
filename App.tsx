...
// FIX: Per @google/genai guidelines, removed ApiKeyEntryScreen as API key should come from process.env.
...
const App: React.FC = () => {
  ...
  // FIX: Per @google/genai guidelines, removed manual API key state management.
  useEffect(() => {
    try {
  ...
  const handleBatchAnalysis = useCallback(async () => {
    ...
    for (const [index, file] of files.entries()) {
      ...
      try {
        ...
        // FIX: Per @google/genai guidelines, call extractInvoiceData without passing an API key.
        ...
        // FIX: Per @google/genai guidelines, removed logic to prompt for API key on error.
