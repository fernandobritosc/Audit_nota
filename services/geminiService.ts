...
export async function extractInvoiceData(base64DataUrl: string, apiKey: string): Promise<ExtractedData> {
    ...
    // FIX: Add responseSchema for more reliable JSON output.
    ...
    try {
        ...
        // FIX: Use response.text which is a property, not a method.
